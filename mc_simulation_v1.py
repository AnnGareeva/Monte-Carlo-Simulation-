...
def make_monte_carlo_simulation(distribution_params,
    ...
    :param show_distribution_flag: True if show the distribution info
    :return: Flag if pass test or not,
            number of iterations it took to pass Smirnov-Kolmogorov test,
            pval,
            dstat,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-sl', '--significance_level', default=0.5, required=False, type=float,
                        help='probability of rejecting the hypothesis for Smirnov-Kolmogorov test')
